...
import { Carousel, HeroContent } from '../features'
  ...
  return (
    <div>
      <section className='bg-fixed '>
        ...
        <div className=' bg-gradient-to-t from-deepMaroon to-#f5f5f5 h-screen w-full relative grid place-items-center md:hidden'>
          <img
            src={hero1}
            alt=''
